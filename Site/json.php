...
$data = $bdd->query('SELECT numpers AS `id`, groupe AS `group`, prenom AS `prename`, nom AS `name` FROM personne'); // on Récupere la liste des personnes selon l'identifiants
